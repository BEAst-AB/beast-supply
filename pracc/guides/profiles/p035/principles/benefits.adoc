...
* save time for the EO to offer their products and services to a CA when the list of products and services are standardized and also when products and 
...
misunderstandings.  
* make it possible for EOs to use tools to pre-fill their information before the specific tender and send the offer in a structured 
