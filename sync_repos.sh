...
sync_repo $POACCREPO $POACCBRANCH "rules/unit-order"  "rules/unit-order" 
sync_repo $POACCREPO $POACCBRANCH "rules/unit-order-response"  "rules/unit-order-response" 
sync_repo $POACCREPO $POACCBRANCH "rules/unit-catalogue"  "rules/unit-catalogue" 
sync_repo $POACCREPO $POACCBRANCH "rules/unit-order-agreement"  "rules/unit-order-agreement"
sync_repo $POACCREPO $POACCBRANCH "rules/unit-invoice-response"  "rules/unit-invoice-response"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-advanced-despatch-advice"  "rules/unit-advanced-despatch-advice"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-common"  "rules/unit-common-logistics"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-receipt-advice"  "rules/unit-receipt-advice"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-transport-execution-plan-request"  "rules/unit-transport-execution-plan-request"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-transport-execution-plan"  "rules/unit-transport-execution-plan"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-transportation-status-request"  "rules/unit-transportation-status-request"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-transportation-status"  "rules/unit-transportation-status"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-waybill"  "rules/unit-waybill"
sync_repo $LOGISTICSREPO $LOGISTICSBRANCH "rules/unit-weight-statement"  "rules/unit-weight-statement"
