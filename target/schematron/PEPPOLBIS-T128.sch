    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
         ...
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B03302">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID">
         ...
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B06802">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B10101">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B10102">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B11801">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B11802">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:Consignment/cac:CarrierParty/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T128-B14301">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T128-B14302">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:ReceiptAdvice/cac:Shipment/cac:TransportHandlingUnit/cbc:TransportHandlingUnitTypeCode">
         <assert test="(some $code in $clUNECERec21 satisfies $code = normalize-space(text()))"
                 flag="fatal"
                 id="PEPPOL-T128-B16101">Value MUST be part of code list 'Recommandation 21 (UN/ECE)'.</assert>
      </rule>
