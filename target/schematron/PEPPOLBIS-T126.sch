<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:TransportationStatusRequest/cbc:ShippingOrderID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T126-B00701">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatusRequest/cac:SenderParty/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T126-B01401">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T126-B01402">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatusRequest/cac:ReceiverParty/cac:PartyIdentification/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T126-B04801">Attribute 'schemeID' MUST be present.</assert>
         <assert test="not(@schemeID) or (some $code in $clICD satisfies $code = @schemeID)"
                 flag="fatal"
                 id="PEPPOL-T126-B04802">Value MUST be part of code list 'ISO 6523 ICD list'.</assert>
      </rule>
      ...
      <rule context="/ubl:TransportationStatusRequest/cac:Consignment/cac:TransportHandlingUnit/cbc:ID">
         <assert test="@schemeID" flag="fatal" id="PEPPOL-T126-B08801">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:TransportationStatusRequest/cac:Consignment/cac:TransportHandlingUnit/*">
