...
POACCBASEURL="https://raw.githubusercontent.com/OpenPEPPOL/poacc-upgrade-3/2025-q4-dev/structure/syntax/"
echo $POACCBASEURL
...
docker run --rm -i -v $PROJECT:/src -v $PROJECT/target/generated:/target atomgraph/saxon \
    -s:https://raw.githubusercontent.com/OpenPEPPOL/peppol-bis-invoice-3/2025-q4-dev/structure/syntax/ubl-invoice.xml \
