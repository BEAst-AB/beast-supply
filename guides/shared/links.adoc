...
:common: https://peppol.org/learn-more/peppol-interoperability-framework/[PEPPOL BIS common text and introduction]:openpeppol: https://peppol.org/about-openpeppol/?rel=tab41[OpenPEPPOL]
...
:main-site: link:/4.0.2[Main documentation site]
