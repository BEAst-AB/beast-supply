...
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue/snippet-structure-1.xml[tags=required-related]
----

.Logistics structure
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue/snippet-structure-1.xml[tags=component-related]
----

.Accessories
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue/snippet-structure-1.xml[tags=complementary-related]
----
