...
.Example of how SSCC number are used for a Transport Handling Unit
[source, xml, indent=0]
----
...
.Example of Transport Handling Unit that is a container
[source, xml, indent=0]
----
...
.Example of goods item within Transport Handling Unit
[source, xml, indent=0]
----
...
.Example of package within Transport Handling Unit
[source, xml, indent=0]
----
