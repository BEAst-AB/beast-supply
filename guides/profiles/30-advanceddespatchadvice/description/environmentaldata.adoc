...
|*ConversionFactor* a|Conversion and emission factor CO2 equivalent for calculating CO2 according to the fuel specified in T0172. 
|*DrivingDistance* a|Driving distance in kilometers that has been used for the assignment.
...
|====
|AttributeID |Definition
|*CO2* a|Amount of fossil CO2-eq based on a life cycle perspective, WTW, to be reported in kilogram. 
|*HC* a|Amount of emission of hydro carbon for the assignment. Preferably reported in kilogram.
