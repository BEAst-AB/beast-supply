...
== BIS documentation
For changes in https://docs.peppol.eu/poacc/upgrade-3/2024-Q4/release-notes/[PoAC] and https://test-docs.peppol.eu/logistics/2024-Q4/release-notes/[LoC releases], please check release-notes for them.
