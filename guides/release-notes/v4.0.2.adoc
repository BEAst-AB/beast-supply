...
*Implementation time*
The CMB has decided to give a time of three months to implement the changes. During 
this period the current version, May release 2023, is still the only version to be used.
...
[horizontal]
This release is based on Peppol POACC version 3.0.12 released 2023-11-27 and Peppol Logistics version 1.2.
