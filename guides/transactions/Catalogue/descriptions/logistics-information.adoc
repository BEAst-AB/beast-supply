...
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue/Snippet_68_log.xml[tags=du]
----
...
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue/Snippet_68_log.xml[tags=tu]
----
<1>  References the sellers item identification for the component line
...
[source, xml, indent=0]
----
include::../../../../rules/snippets/pre-award-catalogue//Snippet_68_log.xml[tags=cu]
----
