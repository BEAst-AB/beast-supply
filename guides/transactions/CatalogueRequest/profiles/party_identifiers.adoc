...
container. This value will be checked against codelists, and only if using values that are in the codelist they will be accepted as valid. 
The codelist used for “EndpointID” is “EAS” (Electronic Address Scheme) and för “ID” in the “PartyIdentification”-container the codelist is 
“ICD” (ISO 6523).
